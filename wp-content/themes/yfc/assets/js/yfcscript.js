window.addEventListener('load', (event) => {
  ...
  const URL       = "https://c8ofs0autc.execute-api.us-east-1.amazonaws.com/prod/contactmail";
          ...
          if(http.readyState === XMLHttpRequest.DONE){
              ...
              if (status === 0 || (status >= 200 && status < 400)) {
                  ...
                  if ("ok" === JSON.parse(http.responseText).result){
                    ...
                    document.getElementById("info").innerHTML = "Sorry. There was a problem. Please sure you're not a robot";
